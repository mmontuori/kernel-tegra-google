...
static bool lp2_on_idle __read_mostly = true;
module_param(lp2_on_idle, bool, 0644);
...
restart:
	...
	/* TODO: boot_secondary polls for CPU1 to boot, wfi would be better */
	/* takes ~80 us */
	boot_secondary(1, NULL);
