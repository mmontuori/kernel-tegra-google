...
#define gpio_pingroup(name, pingroup) \
        [TEGRA_GPIO_P##name]= TEGRA_PINGROUP_##pingroup

static const int gpio_pin_pingroup[] = {
	gpio_pingroup(A0, DTE), gpio_pingroup(A1, UCB),
	gpio_pingroup(A2, DAP2), gpio_pingroup(A3, DAP2),
	gpio_pingroup(A4, DAP2), gpio_pingroup(A5, DAP2),
	gpio_pingroup(A6, SDD), gpio_pingroup(A7, SDD),

	gpio_pingroup(B0, GMC), gpio_pingroup(B1, GMC),
	gpio_pingroup(B2, LPW0), gpio_pingroup(B3, LSC0),
	gpio_pingroup(B4, SDC), gpio_pingroup(B5, SDC),
	gpio_pingroup(B6, SDC), gpio_pingroup(B7, SDC),

	gpio_pingroup(C0, UCB), gpio_pingroup(C1, LPW1),
	gpio_pingroup(C2, UAD), gpio_pingroup(C3, UAD),
	gpio_pingroup(C4, RM), gpio_pingroup(C5, RM),
	gpio_pingroup(C6, LPW2), gpio_pingroup(C7, GMB),

	gpio_pingroup(D0, SLXK), gpio_pingroup(D1, SLXA),
	gpio_pingroup(D2, DTE), gpio_pingroup(D3, SLXC),
	gpio_pingroup(D4, SLXD), gpio_pingroup(D5, DTA),
	gpio_pingroup(D6, DTC), gpio_pingroup(D7, DTC),

	gpio_pingroup(E0, LD0), gpio_pingroup(E1, LD1),
	gpio_pingroup(E2, LD2), gpio_pingroup(E3, LD3),
	gpio_pingroup(E4, LD4), gpio_pingroup(E5, LD5),
	gpio_pingroup(E6, LD6), gpio_pingroup(E7, LD7),

	gpio_pingroup(F0, LD8), gpio_pingroup(F1, LD9),
	gpio_pingroup(F2, LD10), gpio_pingroup(F3, LD11),
	gpio_pingroup(F4, LD12), gpio_pingroup(F5, LD13),
	gpio_pingroup(F6, LD14), gpio_pingroup(F7, LD15),

	gpio_pingroup(G0, ATC), gpio_pingroup(G1, ATC),
	gpio_pingroup(G2, ATC), gpio_pingroup(G3, ATC),
	gpio_pingroup(G4, ATC), gpio_pingroup(G5, ATC),
	gpio_pingroup(G6, ATC), gpio_pingroup(G7, ATC),

	gpio_pingroup(H0, ATD), gpio_pingroup(H1, ATD),
	gpio_pingroup(H2, ATD), gpio_pingroup(H3, ATD),
	gpio_pingroup(H4, ATE), gpio_pingroup(H5, ATE),
	gpio_pingroup(H6, ATE), gpio_pingroup(H7, ATE),


	gpio_pingroup(I0, ATC), gpio_pingroup(I1, ATC),
	gpio_pingroup(I2, ATB), gpio_pingroup(I3, ATA),
	gpio_pingroup(I4, ATA), gpio_pingroup(I5, ATB),
	gpio_pingroup(I6, ATA), gpio_pingroup(I7, ATC),

	gpio_pingroup(J0, GMD), gpio_pingroup(J1, LSPI),
	gpio_pingroup(J2, GMD), gpio_pingroup(J3, LHS),
	gpio_pingroup(J4, LVS), gpio_pingroup(J5, IRTX),
	gpio_pingroup(J6, IRRX), gpio_pingroup(J7, GMC),

	gpio_pingroup(K0, ATC), gpio_pingroup(K1, ATC),
	gpio_pingroup(K2, ATC), gpio_pingroup(K3, ATC),
	gpio_pingroup(K4, ATC), gpio_pingroup(K5, SPDO),
	gpio_pingroup(K6, SPDI), gpio_pingroup(K7, GMC),

	gpio_pingroup(L0, DTD), gpio_pingroup(L1, DTD),
	gpio_pingroup(L2, DTD), gpio_pingroup(L3, DTD),
	gpio_pingroup(L4, DTD), gpio_pingroup(L5, DTD),
	gpio_pingroup(L6, DTD), gpio_pingroup(L7, DTD),

	gpio_pingroup(M0, LD16), gpio_pingroup(M1, LD17),
	gpio_pingroup(M2, LHP1), gpio_pingroup(M3, LHP2),
	gpio_pingroup(M4, LVP1), gpio_pingroup(M5, LHP0),
	gpio_pingroup(M6, LD1), gpio_pingroup(M7, LPP),

	gpio_pingroup(N0, DAP1), gpio_pingroup(N1, DAP1),
	gpio_pingroup(N2, DAP1), gpio_pingroup(N3, DAP1),
	gpio_pingroup(N4, LCSN), gpio_pingroup(N5, LSDA),
	gpio_pingroup(N6, LDC), gpio_pingroup(N7, HDINT),

	gpio_pingroup(O0, UAB), gpio_pingroup(O1, UAA),
	gpio_pingroup(O2, UAA), gpio_pingroup(O3, UAA),
	gpio_pingroup(O4, UAA), gpio_pingroup(O5, UAB),
	gpio_pingroup(O6, UAB), gpio_pingroup(O7, UAB),

	gpio_pingroup(P0, DAP3), gpio_pingroup(P1, DAP3),
	gpio_pingroup(P2, DAP3), gpio_pingroup(P3, DAP3),
	gpio_pingroup(P4, DAP4), gpio_pingroup(P5, DAP4),
	gpio_pingroup(P6, DAP4), gpio_pingroup(P7, DAP4),

	gpio_pingroup(Q0, KBCC), gpio_pingroup(Q1, KBCC),
	gpio_pingroup(Q2, KBCF), gpio_pingroup(Q3, KBCF),
	gpio_pingroup(Q4, KBCF), gpio_pingroup(Q5, KBCF),
	gpio_pingroup(Q6, KBCF), gpio_pingroup(Q7, KBCE),

	gpio_pingroup(R0, KBCA), gpio_pingroup(R1, KBCA),
	gpio_pingroup(R2, KBCA), gpio_pingroup(R3, KBCD),
	gpio_pingroup(R4, KBCD), gpio_pingroup(R5, KBCD),
	gpio_pingroup(R6, KBCD), gpio_pingroup(R7, KBCB),

	gpio_pingroup(S0, KBCB), gpio_pingroup(S1, KBCB),
	gpio_pingroup(S2, KBCB), gpio_pingroup(S3, KBCB),
	gpio_pingroup(S4, KBCB), gpio_pingroup(S5, KBCB),
	gpio_pingroup(S6, KBCB), gpio_pingroup(S7, KBCB),

	gpio_pingroup(T0, DTD), gpio_pingroup(T1, CSUS),
	gpio_pingroup(T2, DTB), gpio_pingroup(T3, DTB),
	gpio_pingroup(T4, DTA), gpio_pingroup(T5, PTA),
	gpio_pingroup(T6, PTA), gpio_pingroup(T7, ATB),

	gpio_pingroup(U0, GPU), gpio_pingroup(U1, GPU),
	gpio_pingroup(U2, GPU), gpio_pingroup(U3, GPU),
	gpio_pingroup(U4, GPU), gpio_pingroup(U5, GPU),
	gpio_pingroup(U6, GPU), gpio_pingroup(U7, GPU7),

	gpio_pingroup(V0, UAC), gpio_pingroup(V1, UAC),
	gpio_pingroup(V2, UAC), gpio_pingroup(V3, UAC),
	gpio_pingroup(V4, GPV), gpio_pingroup(V5, GPV),
	gpio_pingroup(V6, GPV), gpio_pingroup(V7, LVP0),

	gpio_pingroup(W0, LM0), gpio_pingroup(W1, LM1),
	gpio_pingroup(W2, SPIG), gpio_pingroup(W3, SPIH),
	gpio_pingroup(W4, CDEV1), gpio_pingroup(W5, CDEV2),
	gpio_pingroup(W6, UCA), gpio_pingroup(W7, UCA),

	gpio_pingroup(X0, SPIA), gpio_pingroup(X1, SPIB),
	gpio_pingroup(X2, SPIC), gpio_pingroup(X3, SPIC),
	gpio_pingroup(X4, SPID), gpio_pingroup(X5, SPIE),
	gpio_pingroup(X6, SPIE), gpio_pingroup(X7, SPIF),

	gpio_pingroup(Y0, UDA), gpio_pingroup(Y1, UDA),
	gpio_pingroup(Y2, UDA), gpio_pingroup(Y3, UDA),
	gpio_pingroup(Y4, SDIO1), gpio_pingroup(Y5, SDIO1),
	gpio_pingroup(Y6, SDIO1), gpio_pingroup(Y7, SDIO1),

	gpio_pingroup(Z0, SDIO1), gpio_pingroup(Z1, SDIO1),
	gpio_pingroup(Z2, LSDI), gpio_pingroup(Z3, LSC1),
	gpio_pingroup(Z4, LSCK), gpio_pingroup(Z5, PMC),
	gpio_pingroup(Z6, I2CP), gpio_pingroup(Z7, I2CP),

	gpio_pingroup(AA0, GMA), gpio_pingroup(AA1, GMA),
	gpio_pingroup(AA2, GMA), gpio_pingroup(AA3, GMA),
	gpio_pingroup(AA4, GME), gpio_pingroup(AA5, GME),
	gpio_pingroup(AA6, GME), gpio_pingroup(AA7, GME),

	gpio_pingroup(BB0, PMC), gpio_pingroup(BB1, DTE),
	gpio_pingroup(BB2, DTF), gpio_pingroup(BB3, DTF),
	gpio_pingroup(BB4, DTE), gpio_pingroup(BB5, DTE)
};
