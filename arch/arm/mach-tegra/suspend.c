...
static void tegra_suspend_dram(bool lp0_ok)
{
	...
	static __u32 __iomem *avp_resume = IO_ADDRESS(TEGRA_IRAM_BASE);
	...
	writel(*avp_resume, pmc + PMC_SCRATCH39);
...
void __init tegra_init_suspend(struct tegra_suspend_platform_data *plat)
{
	...
	pmc_32kwritel(virt_to_phys(tegra_lp2_startup), PMC_SCRATCH41);
