...
void tegra_pinmux_do_pinmux_table(const struct tegra_pingroup_config *config,
	int len, bool safe_mode)
{
	int i;
...
void tegra_pinmux_set_safe_pinmux_table(const struct tegra_pingroup_config *config,
	int len)
{
	tegra_pinmux_do_pinmux_table(config, len, true);
}

void tegra_pinmux_config_pinmux_table(const struct tegra_pingroup_config *config,
	int len)
{
	tegra_pinmux_do_pinmux_table(config, len, false);
}
