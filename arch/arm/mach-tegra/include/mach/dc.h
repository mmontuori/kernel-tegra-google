...
/* Note: These are the acutal values written to the DC_WIN_COLOR_DEPTH register
 ...
 * windows with differenct dcs in one call
 */
int tegra_dc_update_windows(struct tegra_dc_win *windows[], int n);
int tegra_dc_sync_windows(struct tegra_dc_win *windows[], int n);

/* this will probably replace with an interface describing the window order */
