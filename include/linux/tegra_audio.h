...
#define TEGRA_AUDIO_IN_SET_NUM_BUFS	_IOW(TEGRA_AUDIO_MAGIC, 4, \
			const unsigned int *)
#define TEGRA_AUDIO_IN_GET_NUM_BUFS	_IOR(TEGRA_AUDIO_MAGIC, 5, \
			unsigned int *)
#define TEGRA_AUDIO_IN_GET_DROPPED_BUFS	_IOR(TEGRA_AUDIO_MAGIC, 6, \
			unsigned int *)
#define TEGRA_AUDIO_OUT_SET_NUM_BUFS	_IOW(TEGRA_AUDIO_MAGIC, 7, \
			const unsigned int *)
#define TEGRA_AUDIO_OUT_GET_NUM_BUFS	_IOR(TEGRA_AUDIO_MAGIC, 8, \
			unsigned int *)
#define TEGRA_AUDIO_OUT_GET_DROPPED_BUFS _IOR(TEGRA_AUDIO_MAGIC, 9, \
			unsigned int *)
