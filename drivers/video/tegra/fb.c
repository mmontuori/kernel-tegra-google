				   ...
				   const struct tegra_fb_flip_win *flip_win)
{
	...
	if (flip_win->attr.flags & TEGRA_FB_WIN_FLAG_FLIP_H)
		win->flags |= TEGRA_WIN_FLAG_FLIP_H;
	if (flip_win->attr.flags & TEGRA_FB_WIN_FLAG_FLIP_V)
		win->flags |= TEGRA_WIN_FLAG_FLIP_V;
